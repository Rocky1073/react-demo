  ...
  function notice_remove() {
    ...
    setTimeout(function() {
      try {
        ...
        document
          .querySelector("body > .bk-notice-list")
          .removeChild(notice_item);
      } catch (err) {}

      if (
        document.querySelector("body > .bk-notice-list") &&
        kico.notice_list.childNodes.length === 0
      ) {
...
if (window.console && window.console.log) {
  console.log(
    ...
    "color: #fff; background: #3498db; padding: 5px 0;",
    "background: #efefef; padding: 5px 0; text-decoration: none;"
  );
}
